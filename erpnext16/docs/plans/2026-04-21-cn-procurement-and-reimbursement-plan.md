...
**See also:**
- `erpnext16/docs/plans/2026-04-21-erpnext16-final-scope-and-architecture.md`（当前推荐执行的最终范围与架构方案）
- `erpnext16/docs/plans/2026-04-21-erpnext15-reverse-engineering-and-v16-tax-redesign.md`（ERPNext15 现状逆向分析、业务意图提炼、行级税率可行性与 16 重构方向）
